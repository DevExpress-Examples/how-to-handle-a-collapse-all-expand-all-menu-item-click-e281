...
Namespace Q109817
	...
	Public Class PivotGridViewInfoDataEx
		...
		Public Overrides Overloads Sub FieldChangeExpanded(ByVal field As PivotGridFieldBase, ByVal expanded As Boolean)
			MyBase.FieldChangeExpanded(field, expanded)
